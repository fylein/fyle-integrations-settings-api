...
from apps.integrations.actions import get_integration, get_org_id_from_access_token
...
def test_get_org_id_from_access_token(api_client, mocker, access_token, create_integrations):
    dummy_org_id = 'or3P3xJ0603e'
    mocker.patch(
