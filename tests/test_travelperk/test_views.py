...
def test_travelperk_get_view_case_1(mock_dependencies, api_client, access_token, create_org, create_travelperk, db):
    """
    Test travelperk GET view
    Case: Valid org_id returns 200 with correct data
    """
    url = reverse('travelperk:travelperk', kwargs={'org_id': create_org.id})
...
def test_travelperk_get_view_case_2(mock_dependencies, api_client, access_token, db):
    """
    Test travelperk GET view
...
def test_get_profile_mappings_case_1(mock_dependencies, api_client, access_token, create_org, create_travelperk, db):
    """
...
def test_get_advanced_settings_case_1(mock_dependencies, api_client, access_token, create_org, create_travelperk, db):
    ...
    """
    url = reverse('travelperk:advance-settings-view', kwargs={'org_id': create_org.id})

    travelperk = create_travelperk
    ...
    advanced_settings = TravelperkAdvancedSetting.objects.get(org=create_org.id)
...
def test_disconnect_travelperk_case_1(mock_dependencies, api_client, mocker, access_token, create_org, create_travelperk, create_travelperk_credential, db):
    ...
    add_travelperk_to_integrations(create_org.id)

    integration_objects = Integration.objects.filter(org_id=create_org.fyle_org_id, type='TRAVEL')
...
def test_connect_travelperk_case_1(mock_dependencies, api_client, mocker, access_token, create_org, create_travelperk, create_travelperk_credential, db):
    """
